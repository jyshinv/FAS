...
public class DouriStorageActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_douri_storage);
        ...
        backBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(DouriStorageActivity.this, MainPageActivity.class);
                startActivity(intent);
                finish();
            }
        });

        rv = findViewById(R.id.douri_st_rv);
    ...
    private void setRv() {
        ...
        adapter = new StorageAdapter(this, datas);
