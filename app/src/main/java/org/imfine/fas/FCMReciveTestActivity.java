...
public class FCMReciveTestActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fcmrecive_test);
        ...
        btn2 = findViewById(R.id.fcmreceive_btn_cctvbtn);
        btn2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                //원래코드 :cctv화면으로 이동
                //intent = new Intent(FCMReciveTestActivity.this, DouriCCTV2Activity.class);
